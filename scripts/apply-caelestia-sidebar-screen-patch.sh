...
if [[ -d "$DST/caelestia/modules" ]]; then
  ...
  install -m644 "$PATCH/modules/drawers/Interactions.qml" "$DST/caelestia/modules/drawers/Interactions.qml"
  install -m644 "$PATCH/modules/drawers/Regions.qml" "$DST/caelestia/modules/drawers/Regions.qml"
  mkdir -p "$DST/caelestia/modules/windowpicker" "$DST/caelestia/modules/launcher"
  install -m644 "$PATCH/modules/windowpicker/Wrapper.qml" "$DST/caelestia/modules/windowpicker/Wrapper.qml"
  install -m644 "$PATCH/modules/launcher/Wrapper.qml" "$DST/caelestia/modules/launcher/Wrapper.qml"
  install -m644 "$PATCH/utils/LayoutTweaks.qml" "$DST/caelestia/utils/LayoutTweaks.qml"
