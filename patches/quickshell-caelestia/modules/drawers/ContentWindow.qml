...
StyledWindow {
    ...
    Regions {
        ...
        shellReceivesLauncherPointer: visibilities.launcher && contentItem.Config.launcher.enabled
    ...
    Interactions {
        ...
        Panels {
            ...
            z: ((visibilities.launcher && Config.launcher.enabled) || visibilities.windowPicker) ? 100 : 0
            ...
            quantumMoonPanel.transform: Matrix4x4 {
                matrix: qmBg.deformMatrix
            }
            launcher.transform: Matrix4x4 {
                matrix: launcherBg.deformMatrix
            }
            windowPicker.transform: Matrix4x4 {
                matrix: windowPickerBg.deformMatrix
            }
        ...
        BarWrapper {
            ...
            z: ((visibilities.launcher && Config.launcher.enabled) || visibilities.windowPicker) ? -1 : 0
