...
Item {
    ...
    property bool showVpn: Config.bar.status.showVpn ?? true
    property bool showGitWatcher: Config.bar.status.showGitWatcher ?? true
    ...
    function saveConfig(entryIndex, entryEnabled) {
        ...
        GlobalConfig.bar.status.showVpn = root.showVpn;
        GlobalConfig.bar.status.showGitWatcher = root.showGitWatcher;
                ...
                SectionContainer {
                    ...
                    ConnectedButtonGroup {
                        ...
                        options: [
                            ...
                            {
                                label: qsTr("VPN"),
                                propertyName: "showVpn",
                                onToggled: function (checked) {
                                    root.showVpn = checked;
                                    root.saveConfig();
                                }
                            },
                            {
                                label: qsTr("Git Watcher"),
                                propertyName: "showGitWatcher",
                                onToggled: function (checked) {
                                    root.showGitWatcher = checked;
                                    root.saveConfig();
                                }
                            },
                            {
