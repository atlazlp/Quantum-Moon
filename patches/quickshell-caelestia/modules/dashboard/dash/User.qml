    ...
    Column {
        ...
        Item {
            ...
            Loader {
                ...
                anchors.leftMargin: (Tokens.sizes.dashboard.infoIconSize - width) / 2

                width: Math.floor(Tokens.font.size.normal * 1.34)
                height: width
                sourceComponent: SysInfo.isDefaultLogo ? dashboardOsColoured : dashboardPlanetImage
            }
