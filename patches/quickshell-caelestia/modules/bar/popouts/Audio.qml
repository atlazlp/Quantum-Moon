...
Item {
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            visible: Audio.analogPortsAvailable

            StyledText {
                text: qsTr("Analog output")
                font.weight: 500
            }

            StyledRadioButton {
                ButtonGroup.group: analogOutputs
                checked: Audio.analogActivePort === "speakers"
                onClicked: Audio.setAnalogSpeakers()
                text: qsTr("Speakers")
            }

            StyledRadioButton {
                ButtonGroup.group: analogOutputs
                checked: Audio.analogActivePort === "headphones"
                onClicked: Audio.setAnalogHeadphones()
