...
Item {
    ...
    readonly property bool sidebarAllowedHere: Config.sidebar.enabled
    readonly property bool sidebarDriven: visibilities.sidebar && sidebarAllowedHere
    readonly property bool shouldBeActive: sidebarDriven || (visibilities.utilities && Config.utilities.enabled && !(visibilities.session && Config.session.enabled))
